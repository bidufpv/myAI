  ...
  id ='hero'  >
    <div className="container relative" ref={parallaxRef}>
       ...
       mx-auto text-center mb-[4rem] md:mb-20 lg:mb[6rem]">
        ...
        Unveiling the Future &nbsp;AI&nbsp;Conversations with {` `}
          <span className="inline-block relative ">
                myAI <img src={curve} className="absolute top-full
               left-0 w-full xl:-mt-2" width={624} height={28} alt='curve' />
          </span>
        </h1>
            <p className="body-1 max-w-3xl mx-auto mb-6 text-n-2 lg:mb-8">
            Tap into AI's potential with myAI. 
            Elevate your efficiency with myAI, 
            the ultimate OpenAI chat companion.
            </p>
          ...
          <img src={robot} className="w-full scale-[1.7] translate-y-[8%] md:scale-[1]
           ...
           <ScrollParallax isAbsolutelyPositioned>
            ...
            <ScrollParallax isAbsolutelyPositioned>
                ...
                bottom-[11rem] w-[18rem] xl:flex' title='Generating Code'/>
            </ScrollParallax>
       ...
       <Clients className='hidden relative z-10 mt-20 lg:block '/>
    </div>
    <BottomLine />
    </Section>
};
